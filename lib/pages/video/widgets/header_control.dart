            ...
            child: ListView(
              ...
              children: [
                ...
                ListTile(
                  ...
                  title: const Text('添加到音乐播放列表', style: titleStyle),
                ),
              ],
            ),
          ),
  ...
  void _addToMusicPlaylist() {
    try {
      ...
      final musicItem = MusicItem(
        musicId: videoDetailCtr.bvid,
        title: videoDetail.title ?? '',
        artist: videoDetail.owner?.name ?? '',
        cover: videoDetail.pic ?? videoDetailCtr.cover.value,
        mvAid: videoDetailCtr.aid,
        mvBvid: videoDetailCtr.bvid,
        mvCid: videoDetailCtr.cid.value,
      );
