    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          ListTile(
            onTap: () => Utils.copyText(currentVersion),
          ...
          ListTile(
            onTap: () => PageUtils.launchURL('mailto:w1310025839@gmail.com'),
            leading: const Icon(Icons.feedback_outlined),
            title: const Text('问题反馈'),
            subtitle: Text('w1310025839@gmail.com', style: subTitleStyle),
            trailing: Icon(
              Icons.arrow_forward,
              size: 16,
              color: outline,
