...
List<SettingsModel> get styleSettings => [
  if (Platform.isAndroid)
    NormalModel(
      onTap: (context, setState) => Get.toNamed('/appIconSetting'),
      leading: const Icon(Icons.app_shortcut),
      title: '更换App图标',
      subtitle: '选择你喜欢的App图标样式',
    ),
  ...
  NormalModel(
    onTap: (context, setState) => Get.toNamed('/themeColorSetting'),
    leading: const Icon(Icons.palette_outlined),
    title: '主题色设置',
    subtitle: '自定义系统背景、状态栏、字体、图标颜色',
  ),
  NormalModel(
    onTap: (context, setState) async {
