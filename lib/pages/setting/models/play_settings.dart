...
List<SettingsModel> get playSettings => [
  if (Platform.isAndroid)
    NormalModel(
      ...
      title: '屏幕帧率',
      subtitle: '设置软件显示帧率 (30/60/90/120fps)',
  ...
  const SwitchModel(
    title: '全屏单击快进/快退',
    subtitle: '全屏时单击左1/4快退15s，右1/4快进15s，有1.5s防误触',
    leading: Icon(Icons.skip_next_outlined),
    setKey: SettingBoxKey.enableTapSeek,
    defaultVal: false,
  ),
  const SwitchModel(
    title: '长按滑动全屏手势',
    subtitle: '长按屏幕向上滑动进入全屏，向下滑动退出全屏',
    leading: Icon(Icons.swipe_vertical_outlined),
    setKey: SettingBoxKey.enableLongPressFullscreen,
    defaultVal: false,
  ),
  const SwitchModel(
    title: '左右侧滑动调节亮度/音量',
