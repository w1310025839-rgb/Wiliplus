...
import 'package:PiliPlus/pages/music_search/view.dart';
import 'package:PiliPlus/pages/music_zone/view.dart';
...
import 'package:PiliPlus/pages/setting/app_icon_setting.dart';
...
import 'package:PiliPlus/pages/setting/theme_color_setting.dart';
...
class Routes {
  static final List<GetPage<dynamic>> getPages = [
    ...
    CustomGetPage(name: '/musicPlayer', page: () => const MusicPlayerPage()),
    CustomGetPage(name: '/musicZone', page: () => const MusicZonePage()),
    CustomGetPage(name: '/musicSearch', page: () => const MusicSearchPage()),
    CustomGetPage(
      name: '/popularSeries',
    ...
    CustomGetPage(
      name: '/appIconSetting',
      page: () => const AppIconSettingPage(),
    ),
    CustomGetPage(name: '/friends', page: () => const FriendsPage()),
  ];
}
